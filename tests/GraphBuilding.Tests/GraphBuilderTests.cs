...
public class GraphBuilderTests
{
    ...
    public void CanCreateGraph()
    {
        ...
        var graph = new GraphBuilder(version)
            .AddNode(new() { Id = id1, Coordinates = new(0, 1), Level = 0, SourceId = null })
            .AddNode(new() { Id = id2, Coordinates = new(1, 0), Level = 0, SourceId = null })
            .AddEdge(new() { Id = Guid.NewGuid(), FromId = id1, ToId = id2, SourceId = null })
            .Build();
    ...
    public void CanCheckForNodeExistence()
    {
        ...
        builder.AddNode(new() { Id = id1, Coordinates = new(0, 1), Level = 0, SourceId = null });
