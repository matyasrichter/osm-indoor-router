...
import type { RouteNode } from '../models';
...
export class SearchApi extends runtime.BaseAPI {
	/**
	 */
	async searchClosestNodeGetRaw(
		requestParameters: SearchClosestNodeGetRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<RouteNode>> {
