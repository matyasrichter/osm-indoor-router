...
public partial class AddMapNodeAddMapEdge : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "IX_MapEdges_ToId", table: "MapEdges", column: "ToId");
    }

    /// <inheritdoc />
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropTable(name: "MapEdges");

        migrationBuilder.DropTable(name: "MapNodes");
    }
}
